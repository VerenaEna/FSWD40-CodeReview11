...
<body>
  ...
  if($_POST) {
    ...
    $sql = "UPDATE locations SET ID = '$id', name = '$name', point = '$poi', address = '$address', postcode = '$postcode' WHERE ID = {$id}";

    if($connect->query($sql) === TRUE) {
        echo "<p>Succcessfully Updated</p>";
        echo "<a class='btn btn-dark' href='../updateLoc.php?ID=".$id."'>Back</a>";
