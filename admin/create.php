  ...
  <section class="addMedia center">
    ...
    <form action="actions/a_create.php" method="post" >
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" name="ID" class="form-control" placeholder="ID" aria-label="ID" aria-describedby="basic-addon1" disabled>
      </div>
      ...
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text" id="basic-addon1">Location ID</span>
        </div>
        <input type="text" name="fk_location_ID" class="form-control" placeholder="from 1 to 4" aria-label="image" aria-describedby="basic-addon1">
      </div>
      <div class="buttons">
