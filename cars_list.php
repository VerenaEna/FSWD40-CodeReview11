  ...
  <body>
    ...
    <header class="header">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a class="nav-link" href="office_list.php">Locations</a>
        </li>
        <li class="nav-item">
                  ...
                  <div class='card'>
                    <img class='card-img-top' src='".$row['img']."' alt='Card image of the media' />
                      <div class='card-body'>
                        ...
                        <p class='card-text'>Manufactur company by ".$row['manufactur']."</p>
                        <p class='card-text'><small class='text-muted'> ".$row['amount']." cars available in <a href='office_list.php/#".$row['fk_location_ID']."'>".$row['fk_location_ID']."</a></small></p>
                      </div>
                  </div>
